...
- 013-web-testing: Added Rust unit tests, WASM integration tests, and Playwright E2E tests with CI pipeline support.
- 012-practice-sessions: Added practice session logging with localStorage persistence for web shell.
