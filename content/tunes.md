...
form; day-one guesses like every number here, corrected from the logs. The
...
| 2. Melody | head from memory, 4-bar chunks then joins then full head, out of time | head from memory, click L2, 2 clean passes, ramped to target | TODO(jon) |
