...
public struct Tuple5<T0: Hashable, T1: Hashable, T2: Hashable, T3: Hashable, T4: Hashable>: Hashable {
    ...
    public init(_ field0: T0, _ field1: T1, _ field2: T2, _ field3: T3, _ field4: T4) {
        self.field0 = field0
        self.field1 = field1
        self.field2 = field2
        self.field3 = field3
