...
uint64_t uniffi_shared_fn_clone_corejson(uint64_t handle, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_FREE_COREJSON
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_FREE_COREJSON
void uniffi_shared_fn_free_corejson(uint64_t handle, RustCallStatus *_Nonnull out_status
);
#endif
...
uint64_t uniffi_shared_fn_constructor_corejson_new(RustCallStatus *_Nonnull out_status
...
RustBuffer uniffi_shared_fn_method_corejson_process_event(uint64_t ptr, RustBuffer event_json, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREJSON_VIEW
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREJSON_VIEW
RustBuffer uniffi_shared_fn_method_corejson_view(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
