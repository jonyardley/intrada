...
indirect public enum AppEffect: Hashable {
    ...
    public func serialize<S: Serializer>(serializer: S) throws {
        ...
        case .savePracticeSession(let x):
        ...
        case .saveRoutine(let x):
            try serializer.serialize_variant_index(value: 9)
            try x.serialize(serializer: serializer)
        case .updateRoutine(let x):
    ...
    public static func deserialize<D: Deserializer>(deserializer: D) throws -> AppEffect {
        ...
        case 0:
            ...
            return .loadAll
        case 1:
            let x = try Item.deserialize(deserializer: deserializer)
            try deserializer.decrease_container_depth()
            return .saveItem(x)
        case 2:
            let x = try Item.deserialize(deserializer: deserializer)
        ...
        case 4:
            ...
            return .loadSessions
        case 5:
            let x = try PracticeSession.deserialize(deserializer: deserializer)
            try deserializer.decrease_container_depth()
            return .savePracticeSession(x)
        case 6:
            let id = try deserializer.deserialize_str()
            try deserializer.decrease_container_depth()
            return .deletePracticeSession(id: id)
        case 7:
        ...
        case 9:
            let x = try Routine.deserialize(deserializer: deserializer)
            try deserializer.decrease_container_depth()
            return .saveRoutine(x)
        case 10:
            let x = try Routine.deserialize(deserializer: deserializer)
            try deserializer.decrease_container_depth()
            return .updateRoutine(x)
        case 11:
            let id = try deserializer.deserialize_str()
            try deserializer.decrease_container_depth()
            return .deleteRoutine(id: id)
        case 12:
            let x = try Goal.deserialize(deserializer: deserializer)
            try deserializer.decrease_container_depth()
            return .saveGoal(x)
        case 13:
            let x = try Goal.deserialize(deserializer: deserializer)
