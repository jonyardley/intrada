...
| 2026-09-23 | #PRNUM (#2044) | Fable retired from every role, the review of a sensitive diff included. `reviewer` stays on its Opus 5.5 `high` pin for every diff and `/ship` no longer lifts it; "the Fable list" is renamed the sensitive surfaces, still built at Opus 5.5 `high`. Ends the trial's stop rule, which needed a Fable review to count a miss | Rework: Blockers found after merge on a sensitive surface, not in the report; Spend: total, which should fall with no Fable turns | 2026-09-27, with #1984; the verdict on 2026-10-07 | |
