...
> altitudes are built; see [`status.md`](status.md)). **2a is built bar the
> soft-landing exit** (#1323): the state machine, drill screen, content parser,
> planner and persistence all landed, and the loop runs end to end. The
